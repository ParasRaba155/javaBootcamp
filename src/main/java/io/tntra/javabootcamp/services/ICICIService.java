...
@Service
public class ICICIService extends AccountServiceImpl implements AccountService {

//    private HashMap<String,Account> ICICImap = new HashMap<>();
    @Override
    ...
    public Account updateAccount(String ownerName, Map<String, String> newDetails) throws InvalidOwnerException {
        return super.updateAccount(ownerName,newDetails);
    }
